...
- ``ZTD_IDK_C_SPAN_TYPE``, the type name;
- ``ZTD_IDK_C_SPAN_NAME``, an optional suffix for the ``c_span``\ 's name to override the default which is generated from the type; and,
