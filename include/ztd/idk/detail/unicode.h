...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_lead_surrogate(ztd_char32_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __value >= __ztd_idk_detail_first_lead_surrogate && __value <= __ztd_idk_detail_last_lead_surrogate;
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_trail_surrogate(ztd_char32_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __value >= __ztd_idk_detail_first_trail_surrogate && __value <= __ztd_idk_detail_last_trail_surrogate;
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_surrogate(ztd_char32_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __value >= __ztd_idk_detail_first_surrogate && __value <= __ztd_idk_detail_last_surrogate;
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_single_utf16(ztd_char16_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __value < __ztd_idk_detail_first_lead_surrogate || __value > __ztd_idk_detail_last_trail_surrogate;
}

inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_single_or_lead_utf16(ztd_char16_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __value <= __ztd_idk_detail_last_lead_surrogate || __value > __ztd_idk_detail_last_trail_surrogate;
}

inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) ztd_char32_t
     __ztd_idk_detail_utf16_combine_surrogates(ztd_char16_t __lead, ztd_char16_t __trail) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_lead_overlong_utf8(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return (__value & __ztd_idk_detail_continuation_mask) != __ztd_idk_detail_continuation_signature;
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_lead_utf8(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return (__value & __ztd_idk_detail_continuation_mask) != __ztd_idk_detail_continuation_signature
	     && __value != (ztd_char8_t)(0xC0) && __value != (ztd_char8_t)(0xC1);
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_lead_mutf8(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return (__value & __ztd_idk_detail_continuation_mask) != __ztd_idk_detail_continuation_signature
	     && __value != (ztd_char8_t)(0xC1);
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_trailing_utf8(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return (__value & __ztd_idk_detail_continuation_mask) == __ztd_idk_detail_continuation_signature;
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_is_single_or_lead_utf8(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __ztd_idk_detail_is_lead_utf8(__value);
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_utf8_is_invalid(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __value == 0xC0 || __value == 0xC1 || __value > 0xF4;
}
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_mutf8_is_invalid(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return __value == 0xC1 || __value > 0xF4;
}

inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_utf8_is_overlong(ztd_char32_t __value, ::std::size_t __bytes)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) bool __ztd_idk_detail_utf8_is_overlong_extended(
     ztd_char32_t __value, ::std::size_t __bytes) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return (__value <= __ztd_idk_detail_last_1byte_value && __bytes > 1)
	     || (__value <= __ztd_idk_detail_last_2byte_value && __bytes > 2)
	     || (__value <= __ztd_idk_detail_last_3byte_value && __bytes > 3)
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) int __ztd_idk_detail_utf8_decode_length(ztd_char32_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) int __ztd_idk_detail_utf8_decode_length_overlong(ztd_char32_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	if (__value <= __ztd_idk_detail_last_1byte_value) {
		return 1;
	}
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) int __ztd_idk_detail_utf8_sequence_length(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) int __ztd_idk_detail_utf8_sequence_length_overlong(ztd_char8_t __value)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return (__value & __ztd_idk_detail_start_1byte_mask) == __ztd_idk_detail_start_1byte_continuation ? 1
	     : (__value & __ztd_idk_detail_start_3byte_mask) != __ztd_idk_detail_start_3byte_continuation ? 2
	     : (__value & __ztd_idk_detail_start_4byte_mask) != __ztd_idk_detail_start_4byte_continuation ? 3
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) ztd_char32_t
     __ztd_idk_detail_utf8_decode(ztd_char8_t __value0, ztd_char8_t __value1) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return ((__value0 & 0x1F) << 6) | (__value1 & 0x3F);
}

inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) ztd_char32_t __ztd_idk_detail_utf8_decode(
     ztd_char8_t __value0, ztd_char8_t __value1, ztd_char8_t __value2) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return ((__value0 & 0x0F) << 12) | ((__value1 & 0x3F) << 6) | (__value2 & 0x3F);
}

inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) ztd_char32_t __ztd_idk_detail_utf8_decode(ztd_char8_t __value0,
     ztd_char8_t __value1, ztd_char8_t __value2, ztd_char8_t __value3) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	return ((__value0 & 0x07) << 18) | ((__value1 & 0x3F) << 12) | ((__value2 & 0x3F) << 6) | (__value3 & 0x3F);
}

inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) ztd_char32_t __ztd_idk_detail_utf8_decode(
     ztd_char8_t __value0, ztd_char8_t __value1, ztd_char8_t __value2, ztd_char8_t __value3, ztd_char8_t __value4)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
...
inline ZTD_USE(ZTD_CONSTEXPR_IF_CXX) ztd_char32_t __ztd_idk_detail_utf8_decode(ztd_char8_t __value0,
     ztd_char8_t __value1, ztd_char8_t __value2, ztd_char8_t __value3, ztd_char8_t __value4, ztd_char8_t __value5)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
