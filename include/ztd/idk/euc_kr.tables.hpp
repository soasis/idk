...
#ifndef ZTD_IDK_EUC_KR_TABLES_HPP
#define ZTD_IDK_EUC_KR_TABLES_HPP

#include <ztd/idk/version.hpp>

#include <ztd/idk/euc_kr.tables.h>
...
namespace ztd {
	...
	inline constexpr ::std::optional<ztd_char32_t> euc_kr_index_to_code_point(
		...
		auto __it_and_last = ::ztd::ranges::lower_bound(::ztd::ranges::cbegin(ztd_euc_kr_index_code_point_map),
		     ::ztd::ranges::cend(ztd_euc_kr_index_code_point_map), __lookup_index,
	...
	inline constexpr ::std::optional<::std::size_t> euc_kr_code_point_to_index(
		...
		auto __it_and_last = ::ztd::ranges::find_if(::ztd::ranges::cbegin(ztd_euc_kr_index_code_point_map),
		     ::ztd::ranges::cend(ztd_euc_kr_index_code_point_map), __predicate);
		if (__it_and_last.current == __it_and_last.last) {
			return std::nullopt;
		}
		const ztd_encoding_index16_code_point_t& __index_and_codepoint = *__it_and_last.current;
