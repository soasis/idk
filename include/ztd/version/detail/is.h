...
#define ZTD_RAW_IS_ON(_OP_SYMBOL) ((3 _OP_SYMBOL 3) != 0)
#define ZTD_RAW_IS_OFF(_OP_SYMBOL) ((3 _OP_SYMBOL 3) == 0)
#define ZTD_RAW_IS_DEFAULT_ON(_OP_SYMBOL) ((3 _OP_SYMBOL 3) > 3)
#define ZTD_RAW_IS_DEFAULT_OFF(_OP_SYMBOL) ((3 _OP_SYMBOL 3 _OP_SYMBOL 3) < 0)

#define ZTD_IS_ON(_OP_SYMBOL) ZTD_RAW_IS_ON(_OP_SYMBOL##_I_)
#define ZTD_IS_OFF(_OP_SYMBOL) ZTD_RAW_IS_OFF(_OP_SYMBOL##_I_)
#define ZTD_IS_DEFAULT_ON(_OP_SYMBOL) ZTD_RAW_IS_DEFAULT_ON(_OP_SYMBOL##_I_)
#define ZTD_IS_DEFAULT_OFF(_OP_SYMBOL) ZTD_RAW_IS_DEFAULT_OFF(_OP_SYMBOL##_I_)
